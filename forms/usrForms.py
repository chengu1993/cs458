...
class RegistForm(forms.Form):
    ...
    drink_level = forms.ChoiceField(choices=[('0', 'abstemious'), ('1', 'social drinker'), ('2', 'casual drinker')])
    smoker = forms.ChoiceField(choices=[('1', 'I am a smoker'), ('0', 'I never smoking')], widget=forms.RadioSelect())
    age = forms.IntegerField()
    marital_status = forms.ChoiceField(choices=[('0', 'single'), ('1', 'married'), ('2', 'widow')])
    hijos = forms.ChoiceField(choices=[('0', 'independent'), ('1', 'kids'), ('2', 'dependent')])
    interest = forms.ChoiceField(choices=[('0', 'variety'), ('1', 'technology'),
                                          ('2', 'none'), ('3', 'retro'), ('4', 'eco-friendly')])
    personality = forms.ChoiceField(choices=[('0', 'thrifty-protector'), ('1', 'hunter-ostentatious'),
                                             ('2', 'hard-worker'), ('3', 'conformist')])
    religion = forms.ChoiceField(choices=[('0', 'none'), ('1', 'Catholic'),
                                          ('2', 'Christian'), ('3', 'Mormon'), ('4', 'Jewish')])
    activity = forms.ChoiceField(choices=[('0', 'student'), ('1', 'professional'),
